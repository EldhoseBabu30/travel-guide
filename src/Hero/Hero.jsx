      ...
      <div className="relative top-0 left-0 w-full h-full bg-black/50 z-20">
        <div className="flex items-center justify-center w-full h-full relative z-30 flex-col">
          <div className="my-20 text-center md:text-left">
            <h1 className="text-white text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:absolute md:top-48 md:left-20">
              Discover Mesmerizing India <br />
              with NjanSanchari
            </h1>
            <p className="text-white opacity-50 text-lg md:text-xl lg:text-2xl font-thin mb-8 md:absolute md:top-[22rem] md:left-20">
          ...
          <div className="bg-white rounded-full h-16 max-w-3xl w-full mx-auto mt-8 md:mt-[21rem]">
            <form className="flex flex-col md:flex-row">
              ...
              <button
                className="inline-flex rounded-full items-center h-16 bg-indigo-500 text-white px-8 py-5 mx-2 my-3 md:my-0 space-x-2"
                type="submit"
              >
                Explore Now
              </button>
          ...
          <p className="absolute left-1/2 transform -translate-x-1/2 bottom-12 text-white opacity-50 font-thin md:left-24">
