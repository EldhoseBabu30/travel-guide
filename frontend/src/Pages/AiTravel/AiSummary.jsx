  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-100 to-purple-200 flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-xl w-full max-w-2xl p-4 sm:p-6 relative overflow-hidden"
      >
        ...
        <div className="space-y-2 sm:space-y-4 max-h-64 sm:max-h-96 overflow-y-auto pr-2">
        ...
        >
          <motion.button
            ...
            className="bg-gradient-to-r from-orange-400 to-purple-500 text-white px-4 sm:px-6 py-2 rounded-full text-base sm:text-lg font-semibold shadow-md hover:shadow-lg transition-all"
          >
            🏁 Build My Itinerary →
          </motion.button>
        </motion.div>
