...
import video from '../../assets/kodaikanal.mp4';
import mapOutline from '../../assets/kodaikanal-outline.png';
...
import itineraryMap from '../../assets/kodaikanal1.jpg'

// Data for attractions
const attractions = [
  {
    name: "Bryant Park",
    coords: { lat: 10.2303, lng: 77.4893 },
    image: topImage1,
    review: "Bryant Park offers a beautiful variety of flowers and plants, a must-see botanical garden in Kodaikanal.",
  },
  {
    name: "Kodaikanal Lake",
    coords: { lat: 10.2381, lng: 77.4890 },
    image: topImage2,
    review: "Kodaikanal Lake is perfect for boat rides and picturesque views, ideal for a relaxing day out exploring.",
  },
  {
    name: "Pillar Rocks",
    coords: { lat: 10.1378, lng: 77.4893 },
    image: topImage3,
    review: "Pillar Rocks, towering high, offer stunning panoramic views, a breathtaking and unique experience indeed.",
  },
  {
    name: "Coaker's Walk",
    coords: { lat: 10.2345, lng: 77.4908 },
    image: topImage4,
    review: "Coaker's Walk offers a scenic and serene stroll with beautiful views, perfect for a leisurely walk in Kodaikanal.",
  },
];
...
// Data for deals in Kodaikanal
const deals = [
  { id: 1, category: "Room", name: "The Carlton Kodaikanal", address: "Lake Road", price: 320, image: "https://via.placeholder.com/400x300" },
  { id: 2, category: "Room", name: "Sterling Kodai Lake", address: "44, Gymkhana Road", price: 290, image: "https://via.placeholder.com/400x300" },
  { id: 3, category: "Room", name: "Kodai Resort Hotel", address: "Coaker's Walk", price: 260, image: "https://via.placeholder.com/400x300" },
  { id: 4, category: "Room", name: "The Tamara Kodai", address: "No. 22, La Providence", price: 310, image: "https://via.placeholder.com/400x300" },
  { id: 5, category: "Restroom", name: "Public Restroom - Bryant Park", address: "Near Bryant Park Entrance", price: 15, image: "https://via.placeholder.com/400x300" },
  { id: 6, category: "Restroom", name: "Public Restroom - Coaker's Walk", address: "Coaker's Walk Entrance", price: 15, image: "https://via.placeholder.com/400x300" },
  { id: 7, category: "EV Parking", name: "EV Parking - Lake Road", address: "Near Kodaikanal Lake", price: 90, image: "https://via.placeholder.com/400x300" },
  { id: 8, category: "EV Parking", name: "EV Parking - Chettiar Park", address: "Chettiar Park Entrance", price: 90, image: "https://via.placeholder.com/400x300" },
  { id: 9, category: "Parking", name: "Parking - Kodai Lake", address: "Lake Road", price: 60, image: "https://via.placeholder.com/400x300" },
  { id: 10, category: "Parking", name: "Parking - Pillar Rocks", address: "Pillar Rocks Road", price: 60, image: "https://via.placeholder.com/400x300" },
];
    ...
    <div className="font-sans">
        ...
        <div className="relative h-full">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
            <div className="inline-block relative">
              <h1 className="text-6xl font-bold mb-4">Travel to Kodaikanal</h1>
              ...
              <img src={mapOutline} alt="Map Outline" className="absolute top-0 left-full w-[60%] ml-4" />
            </div>
          </div>
      ...
      <section className="py-16 px-8 bg-gray-100 text-gray-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start">
          ...
          <div className="md:w-1/2">
            <p className="mb-8">
            Think big. Kodaikanal is renowned for its lush green hills, pristine lakes, and enchanting landscapes. The cool climate and serene atmosphere make it an ideal getaway from the hustle and bustle of city life. Kodaikanal offers numerous opportunities for tranquil retreats and adventure activities alike. Slow down, embrace the tranquility, and immerse yourself in the natural beauty of Kodaikanal.            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-8 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-semibold mb-8">Things to Do in Kodaikanal</h2>
      ...
      <section className="py-16 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-semibold mb-8">Interactive Map of Kodaikanal</h2>
