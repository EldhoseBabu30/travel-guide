    ...
    <div className="font-sans">
      <header className="relative bg-cover bg-center h-screen" style={{ backgroundImage: 'url(/path-to-your-munnar-image.jpg)' }}>
        ...
        <div className="relative z-10 text-white p-8 text-center">
          <div className="mt-32">
            <h1 className="text-6xl font-bold">Travel to Kodaikanal</h1>
      ...
      <section className="py-16 px-8 bg-gray-100 text-gray-800">
        <div className="max-w-4xl mx-auto">
          ...
          <img src="/path-to-your-munnar-image2.jpg" alt="Kodaikanal" className="w-full h-auto rounded-lg shadow-lg mb-8"/>
        </div>
      </section>
