...
const attractions = [
  {
    ...
    image: topImage1,
    review:
      "The lush green tea gardens of Munnar are a must-see, offering stunning views and serene ambiance.",
  },
  {
    name: "Mattupetty Dam",
    ...
    image: topImage2,
    review:
      "Mattupetty Dam offers picturesque views and boat rides, perfect for a tranquil and scenic outing.",
  },
  {
    ...
    image: topImage3,
    review:
      "Home to the endangered Nilgiri Tahr, this park is a wildlife haven with breathtaking natural beauty.",
  },
  {
    name: "Echo Point",
    coords: { lat: 10.0743, lng: 77.163 },
    image: topImage4,
    review:
      "A scenic spot with natural echoes and beautiful views, ideal for a memorable and fun visit anytime.",
  },
];
      ...
      if (status === window.google.maps.places.PlacesServiceStatus.OK) {
        ...
        service.getDetails(placeRequest, (placeDetailsResult, placeStatus) => {
          if (
            ...
            const photoUrl =
              placeDetailsResult.photos && placeDetailsResult.photos.length > 0
                ? placeDetailsResult.photos[0].getUrl()
                : "";
            const review =
              placeDetailsResult.reviews &&
              placeDetailsResult.reviews.length > 0
        ...
        <div className="relative h-full">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
            <div className="inline-block relative">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 mx-2">
                Travel to Munnar
              </h1>
              <p className="text-md sm:text-lg md:text-xl mb-6 mx-2 sm:whitespace-pre-line">
                Whatever you want, our experts can make it happen.
              </p>
              <div className="flex justify-center gap-4 flex-wrap sm:flex-nowrap">
                <button className="bg-orange-400 hover:bg-orange-500 text-white py-2 px-4 rounded-lg">
                  Craft your trip
                </button>
                <button className="bg-gray-600 hover:bg-gray-800 bg-opacity-70 text-white py-2 px-4 rounded-lg">
                  How it works
                </button>
              </div>
              <img
                src={mapOutline}
                alt="Map Outline"
                className="absolute top-0 left-full w-100 ml-4 hidden md:block"
              />
            </div>
          </div>
          <div className="absolute bottom-0 left-0 w-full text-center bg-black bg-opacity-60 p-4">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 text-white text-xs sm:text-sm md:text-base">
              ...
              <div
                className="flex flex-col items-center sm:border-none"
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start">
          <div className="md:w-1/2 md:pr-8 mb-8 md:mb-0">
            <h2 className="text-3xl font-bold mb-4">
              Beyond the city limits, nature comes unabashed and boundless
            </h2>
          </div>
          <div className="md:w-1/2">
            <p className="mb-8">
              Think big. Munnar boasts sprawling tea gardens, lush green hills,
              and picturesque landscapes. The pleasant climate and serene
              atmosphere make it a perfect escape from the bustling city life.
              Munnar offers countless opportunities for peaceful retreats and
              adventure activities alike. Slow down, embrace the tranquility,
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            ...
            <div className="md:w-1/2 flex flex-col items-center">
              <div className="relative w-full h-64 rounded-lg overflow-hidden shadow-lg mb-4">
                <img
                  src={itineraryMap}
                  alt="Itinerary Map Thumbnail"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="mt-4 p-4 bg-gray-100 rounded-lg text-center shadow-lg w-full">
                <h3 className="font-bold text-xl">
                  Samba, Paraty and Rio de Janeiro
                </h3>
                <button className="mt-4 bg-orange-400 hover:bg-orange-500 text-white font-bold py-2 px-6 rounded">
                  View Itinerary
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-lg font-semibold mb-2">
                From USD 3400 per person
              </p>
              <p className="text-gray-500">
                Includes flights and private transfers
              </p>
            </div>
            <div className="lg:w-2/3 lg:pl-8">
              <h3 className="text-xl font-bold mb-2">Why book with us?</h3>
              <p className="mb-2">
                We offer an unparalleled level of service and attention to
                detail. Our itineraries are crafted with care to ensure you have
                the most immersive and unforgettable experience. We handle all
                the logistics so you can focus on enjoying your trip.
              </p>
            ...
            {attractions.map((attraction, index) => (
              <div key={index} className="w-full md:w-1/2 lg:w-1/4 px-4 mb-8">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                  <img
                    src={placeDetails[index]?.photoUrl || attraction.image}
                    alt={attraction.name}
                    className="w-full h-48 object-cover"
                  />
                  <div className="p-4">
                    <h3 className="text-xl font-semibold mb-2">
                      {placeDetails[index]?.name || attraction.name}
                    </h3>
                    <p className="text-gray-700">
                      {placeDetails[index]?.review || attraction.review}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative h-96">
                  ...
                  {currentAttractionIndex === index && (
                    <InfoWindow position={attraction.coords}>
                      <div>
                        ...
                        <img
                          src={
                            placeDetails[index]?.photoUrl || attraction.image
                          }
                          alt={attraction.name}
            ...
            <div className="absolute top-0 left-0 mt-2 ml-2 bg-white shadow-md rounded-md p-2">
              <button onClick={handlePreviousAttraction} className="mr-2">
                &larr; Previous
              </button>
