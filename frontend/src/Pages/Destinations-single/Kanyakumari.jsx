...
import mapOutline from '../../assets/kanyakumari-outline.png';
...
import itineraryMap from '../../assets/kanyakumari1.jpg'

// Data for attractions in Kanyakumari
const attractions = [
  {
...
const deals = [
  { id: 1, category: "Room", name: "Sparsa Resort ", address: "Beach Road", price: 450, image: "https://via.placeholder.com/400x300" },
  { id: 2, category: "Room", name: "Hotel Sea View", address: "East Car Street", price: 300, image: "https://via.placeholder.com/400x300" },
  { id: 3, category: "Room", name: "The Gopinivas Grand", address: "Main Road", price: 250, image: "https://via.placeholder.com/400x300" },
  { id: 4, category: "Room", name: "Hotel Sangam", address: "South Car Street", price: 200, image: "https://via.placeholder.com/400x300" },
  { id: 5, category: "Restroom", name: "Public Restroom - Kanyakumari Beach", address: "Near Kanyakumari Beach Entrance", price: 10, image: "https://via.placeholder.com/400x300" },
  { id: 6, category: "Restroom", name: "Public Restroom - Vivekananda Rock", address: "Vivekananda Rock Entrance", price: 10, image: "https://via.placeholder.com/400x300" },
  { id: 7, category: "EV Parking", name: "EV Parking - Kanyakumari Beach", address: "Kanyakumari Beach Parking Area", price: 70, image: "https://via.placeholder.com/400x300" },
  { id: 8, category: "EV Parking", name: "EV Parking - Railway Station", address: "Kanyakumari Railway Station", price: 70, image: "https://via.placeholder.com/400x300" },
  { id: 9, category: "Parking", name: "Parking - Kanyakumari Beach", address: "Kanyakumari Beach Parking Area", price: 50, image: "https://via.placeholder.com/400x300" },
  { id: 10, category: "Parking", name: "Parking - Vivekananda Rock", address: "Vivekananda Rock Parking Area", price: 50, image: "https://via.placeholder.com/400x300" },
];
    ...
    <div className="font-sans">
        ...
        <div className="relative h-full">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
            <div className="inline-block relative">
              <h1 className="text-6xl font-bold mb-4">Travel to Kanyakumari</h1>
              ...
              <img src={mapOutline} alt="Map Outline" className="absolute top-0 left-full w-[50%] ml-4" />
            </div>
          </div>
      ...
      <section className="py-16 px-8 bg-gray-100 text-gray-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start">
          ...
          <div className="md:w-1/2">
            <p className="mb-8">
            Think big. Kanyakumari is renowned for its stunning sunrises and sunsets, where the Bay of Bengal, the Arabian Sea, and the Indian Ocean converge. The pleasant climate and serene atmosphere make it a perfect escape from bustling city life. Kanyakumari offers countless opportunities for peaceful retreats and cultural explorations alike. Slow down, embrace the tranquility, and immerse yourself in the beauty of nature and heritage.           </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-8 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-semibold mb-8">Things to Do in Kanyakumari</h2>
      ...
      <section className="py-16 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-semibold mb-8">Interactive Map of Kanyakumari</h2>
