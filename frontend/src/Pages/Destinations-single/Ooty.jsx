...
import mapOutline from '../../assets/ooty-outline.png';
...
import itineraryMap from '../../assets/ooty1.jpg'

// Data for attractions
const attractions = [
  {
    name: "Botanical Gardens",
    coords: { lat: 11.4148, lng: 76.6932 },
    image: topImage1,
    review: "The Government Botanical Gardens offer a wide variety of plants and flowers, a must-see in Ooty.",
  },
  {
    name: "Ooty Lake",
    coords: { lat: 11.4030, lng: 76.6846 },
    image: topImage2,
    review: "Ooty Lake is perfect for boat rides and picturesque views, ideal for a relaxing day out exploring.",
  },
  {
    name: "Doddabetta Peak",
    coords: { lat: 11.4017, lng: 76.7357 },
    image: topImage3,
    review: "Doddabetta Peak, the highest in the Nilgiris, offers stunning panoramic views, a breathtaking experience indeed.",
  },
  {
    name: "Rose Garden",
    coords: { lat: 11.4134, lng: 76.7004 },
    image: topImage4,
    review: "The sprawling Rose Garden showcases thousands of rose varieties, perfect for a leisurely stroll in Ooty.",
  },
];
...
// Data for deals
const deals = [
  { id: 1, category: "Room", name: "Savoy - IHCL SeleQtions", address: "77 Sylks Road", price: 300, image: "https://via.placeholder.com/400x300" },
  { id: 2, category: "Room", name: "Sterling Ooty Fern Hill", address: "73 Kundah House Road", price: 275, image: "https://via.placeholder.com/400x300" },
  { id: 3, category: "Room", name: "Gem Park Ooty", address: "Sheddon Road", price: 250, image: "https://via.placeholder.com/400x300" },
  { id: 4, category: "Room", name: "Fortune Resort", address: "123 Selbourne Road", price: 260, image: "https://via.placeholder.com/400x300" },
  { id: 5, category: "Restroom", name: "Public Restroom - Botanical Garden", address: "Near Botanical Garden Entrance", price: 20, image: "https://via.placeholder.com/400x300" },
  { id: 6, category: "Restroom", name: "Public Restroom - Ooty Lake", address: "Ooty Lake Boat House", price: 20, image: "https://via.placeholder.com/400x300" },
  { id: 7, category: "EV Parking", name: "EV Parking - Upper Bazaar", address: "Upper Bazaar Road", price: 100, image: "https://via.placeholder.com/400x300" },
  { id: 8, category: "EV Parking", name: "EV Parking - Ooty Lake", address: "Ooty Lake Parking Area", price: 100, image: "https://via.placeholder.com/400x300" },
  { id: 9, category: "Parking", name: "Parking - Charing Cross", address: "Charing Cross Road", price: 75, image: "https://via.placeholder.com/400x300" },
  { id: 10, category: "Parking", name: "Parking - Rose Garden", address: "Rose Garden Entrance", price: 75, image: "https://via.placeholder.com/400x300" },
];
...
`}</style>
      ...
      <section className="py-16 px-8 bg-gray-100 text-gray-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start">
          ...
          <div className="md:w-1/2">
            <p className="mb-8">
            Think big. Ooty boasts sprawling tea estates, rolling green hills, and picturesque landscapes. The pleasant climate and serene atmosphere make it a perfect escape from bustling city life. Ooty offers countless opportunities for peaceful retreats and adventure activities alike. Slow down, embrace the tranquility, and immerse yourself in the beauty of nature.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-8 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-semibold mb-8">Things to Do in Ooty</h2>
      ...
      <section className="py-16 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-semibold mb-8">Interactive Map of Ooty</h2>
